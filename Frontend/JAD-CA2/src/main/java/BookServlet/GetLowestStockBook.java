...
/**
 * Servlet implementation class GetLowestStockBook
 */
@WebServlet("/GetLowestStockBook")
public class GetLowestStockBook extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetLowestStockBook() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String restUrl = "http://localhost:8081/store/books/getLowestStockBooks/3";
