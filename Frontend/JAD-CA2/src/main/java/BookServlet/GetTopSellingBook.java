...
/**
 * Servlet implementation class GetTopSellingBook
 */
@WebServlet("/GetTopSellingBook")
public class GetTopSellingBook extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetTopSellingBook() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String restUrl = "http://localhost:8081/store/books/getTopSellingBooks/3";
