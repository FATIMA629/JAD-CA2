...
/**
 * Servlet implementation class GetNewestBook
 */
@WebServlet("/GetNewestBook")
public class GetNewestBook extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetNewestBook() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String restUrl = "http://localhost:8081/store/books/getNewestBooks/3";
